...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "C:/Users/Meera/Downloads/fleet-reserve-437414-a9-a056dd8bf8f1.json"
project_name = os.getenv("VERTEXAI_PROJECT")
vertexai.init(project=project_name)

# Setting page title and header
st.set_page_config(page_title="Gemini Edu Chatbot", page_icon=":robot_face:")
st.markdown("<h1 style='text-align: center;'>LEARNING AI</h1>", unsafe_allow_html=True)
